...
export function PortalShareCard({
  ...
  const portalImage =
    portal.image ||
    disasterTypeImages[
      portal.disasterType as keyof typeof disasterTypeImages
    ] ||
    "/templates/other.jpg";
                ...
                <Button variant="outline" className="w-full" asChild>
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(
                      ...
                      `Join the disaster relief efforts for ${portal.title}`
                    )}`}
                    target="_blank"
                ...
                <Button variant="outline" className="w-full" asChild>
                  <a
                    href={`mailto:?subject=${encodeURIComponent(
                      ...
                      `Please join the disaster relief efforts for ${portal.title}. Visit: ${portalUrl}`
                    )}`}
                    className="flex items-center justify-center"
                  >
              ...
              >
                <div className="relative h-48">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3
                      className="text-xl font-semibold text-white line-clamp-2 mb-1"
