...
export default function VolunteerPage() {
  ...
  return (
    <>
      <Head>
        <title>Volunteer | Kutumbakam Disaster Relief</title>
        <meta name="description" content="Become a volunteer with Kutumbakam and help communities in need during disasters. Register, coordinate, and make a difference today." />
        <meta name="keywords" content="Volunteer, Disaster Relief, Community Support, Kutumbakam, Open Source, Social Impact, Emergency, Help, Coordination" />
        <meta property="og:title" content="Volunteer | Kutumbakam Disaster Relief" />
        <meta property="og:description" content="Join Kutumbakam as a volunteer and support disaster-affected communities. Register and coordinate relief efforts." />
        <meta property="og:url" content="https://devkutumbakam.vercel.app/volunteer" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://devkutumbakam.vercel.app/img%20(1).png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Volunteer | Kutumbakam Disaster Relief" />
        <meta name="twitter:description" content="Become a volunteer with Kutumbakam and help communities in need during disasters." />
        <meta name="twitter:image" content="https://devkutumbakam.vercel.app/img%20(1).png" />
        <link rel="canonical" href="https://devkutumbakam.vercel.app/volunteer" />
      </Head>
