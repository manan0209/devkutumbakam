...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About | Kutumbakam Disaster Relief Portal</title>
        <meta name="description" content="Learn about Kutumbakam, an open-source disaster relief platform uniting communities, volunteers, and resources for rapid, transparent, and effective humanitarian response." />
        <meta name="keywords" content="About Kutumbakam, Disaster Relief, Open Source, Community, Volunteer, Humanitarian, Social Impact, Vasudhaiva Kutumbakam" />
        <meta property="og:title" content="About | Kutumbakam Disaster Relief Portal" />
        <meta property="og:description" content="Kutumbakam is a modern disaster relief platform built for rapid, transparent, and effective humanitarian response. Learn more about our mission and vision." />
        <meta property="og:url" content="https://devkutumbakam.vercel.app/about" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://devkutumbakam.vercel.app/img%20(1).png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About | Kutumbakam Disaster Relief Portal" />
        <meta name="twitter:description" content="Learn about Kutumbakam, the open-source disaster relief platform for community-driven response and support." />
        <meta name="twitter:image" content="https://devkutumbakam.vercel.app/img%20(1).png" />
        <link rel="canonical" href="https://devkutumbakam.vercel.app/about" />
      </Head>
